...
model = keras.models.load_model('nutri_bot_model.h5')
# Opening the pickle file for vocabulary and encoders
with open("data_nutribot.pickle", "rb") as f:
...
class ChatWindow(Screen):
    ...
    # This is the message appearance area
...
# pyinstaller --onefile ChatBotGUI.py
